export async function postScannerLoggingEnabled(enable: boolean): Promise<void> {
...
export async function postScannerConnectEth(props: Readonly<PostScannnerConnectEthBody>): Promise<void> {
...
export async function postScannerConnectSer(props: Readonly<PostScannnerConnectSerBody>): Promise<void> {
  const fromBody = new FormData();
